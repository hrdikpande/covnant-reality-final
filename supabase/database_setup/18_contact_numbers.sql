-- ==========================================
-- 18_CONTACT_NUMBERS.SQL
-- Add contact number fields to properties table
-- ==========================================

-- Add contact number fields (safe to run multiple times)
ALTER TABLE properties
ADD COLUMN IF NOT EXISTS contact_number TEXT,
ADD COLUMN IF NOT EXISTS whatsapp_number TEXT,
ADD COLUMN IF NOT EXISTS allow_phone BOOLEAN DEFAULT TRUE,
ADD COLUMN IF NOT EXISTS allow_whatsapp BOOLEAN DEFAULT TRUE;

-- Update submit_property RPC to handle new fields
...
BEGIN
  ...
  INSERT INTO properties (
    ...
    city, city_id, state, state_id, pincode, rera_number,
    contact_number, whatsapp_number, allow_phone, allow_whatsapp,
...
-- Update admin_submit_property RPC to handle new fields
...
BEGIN
  ...
  INSERT INTO properties (
    ...
    city_id, state, state_id, pincode, rera_number,
    contact_number, whatsapp_number, allow_phone, allow_whatsapp,
    status, is_verified, is_featured
  )
  VALUES (
