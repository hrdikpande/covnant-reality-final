-- ==========================================
-- 19_FIX_AMENITIES_CHAT.SQL
-- Add amenities and allow_chat columns to properties table
-- ==========================================
...
-- Update submit_property RPC (Full replacement to include all new fields)
...
-- Update admin_submit_property RPC
