...
export function BuilderProfileSettings() {
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (success && url) {
      ...
      setUploadMsg(`Error: ${error || "Failed to upload logo."}`);
    }
        ...
        <Card>
          <CardContent className="p-6 flex flex-col items-center text-center">
            <div className="relative mb-4">
              <div className="w-24 h-24 rounded-2xl overflow-hidden border-4 border-white shadow-md relative group bg-slate-100 flex items-center justify-center">
                {profile?.avatar_url ? (
                  <Image
            ...
            <p className="text-sm font-medium text-text-secondary mt-1 max-w-[200px]">
              {profile?.role === "builder" ? "Developer" : profile?.role ?? "Builder"} @ Covnant Reality
            </p>
            ...
            <Card>
              <CardHeader className="p-5 sm:p-6 border-b border-border/50">
                ...
                <p className="text-sm text-text-secondary">
                  Update your builder logo and primary corporate details here.
                </p>
              </CardHeader>
